    ...
    public void deferredFree(int v) {
        ...
        synchronized (to_free) {
            if (to_free_length == to_free.length) {
                /*bdd*/
                int[] t = new /*bdd*/int[to_free.length * 2];
