...
public class Trim extends FeatureModel implements CommonVarNames {
    ...
    public Trim() {
        ...
        grade.setDerived(true);
        engine.setDerived(true);
        transmission.setDerived(true);
