...
import com.tms.threed.imageModel.builders.shared.NodeLevel;
...
public class VNodeBuilder {
    ...
    public VNodeBuilder(FeatureModel featureModel, SeriesInfo seriesInfo, Path pngRootFs) {
        this.seriesInfo = seriesInfo;
        this.featureModel = featureModel;
        this.pngRootFs = pngRootFs;
    ...
    private com.tms.threed.util.vnode.server.VNodeBuilder createVNodeBuilder() {
        Path pSeriesPngRoot = seriesInfo.getSeriesKey().getSeriesPngRoot(pngRootFs);
        File fSeriesPngRoot = new File(pSeriesPngRoot.toString());
        com.tms.threed.util.vnode.server.VNodeBuilder builder;
        builder = new com.tms.threed.util.vnode.server.VNodeBuilder(fSeriesPngRoot);
